...
class WorkerTests(unittest.TestCase):
    ...
    def test__work__when__energy_is_0__expect_to_raise(self):
    ...
    def test__work_enough_energy__expect_money_to_be_increased_by_salary(self):
        self.worker.work()
        self.worker.work()
        self.assertEqual(2 * self.SALARY, self.worker.money)

    def test__work__when_enough_energy__expect_energy_to_be_decremented(self):
        self.worker.work()
